...
def render_resume(data):
    ...
    result = subprocess.run(
        ['tectonic', 'output/temp_resume.tex'], capture_output=True, text=True)
...
sample_data = {
    ...
    "education": [
        {"school": "Texas A\&M University", "dates": "Aug 2025 -- Dec 2026",
            "degree": "Master of Computer Science", "location": "TX"}
    ],
    "experiences": [
        {
            "company": "SaturnAI",
            ...
            "location": "Taiwan",
            "bullets": ["Engineered real-time monitoring systems.", "Scaled ingestion to 30 concurrent streams."]
        }
    ],
    "projects": [
        {
